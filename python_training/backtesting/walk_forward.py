...
class WalkForwardOptimizer:
    ...
    def __init__(self, project_root: Path):
        ...
        # WFO fold definitions - 12 folds for rigorous validation
        # Format: (train_start, train_end, test_start, test_end)
        # Each test period is ~6 months for balanced signal-to-noise
        self.folds = [
            ("2019-01-01", "2020-06-30", "2020-07-01", "2020-12-31"),  # Fold 1: COVID era
            ("2019-01-01", "2020-12-31", "2021-01-01", "2021-06-30"),  # Fold 2: Post-COVID
            ("2019-01-01", "2021-06-30", "2021-07-01", "2021-12-31"),  # Fold 3: 2021 H2
            ("2019-01-01", "2021-12-31", "2022-01-01", "2022-06-30"),  # Fold 4: Pre-Fed hikes
            ("2019-07-01", "2022-06-30", "2022-07-01", "2022-12-31"),  # Fold 5: Fed hikes peak
            ("2020-01-01", "2022-12-31", "2023-01-01", "2023-06-30"),  # Fold 6: Banking crisis
            ("2020-07-01", "2023-06-30", "2023-07-01", "2023-12-31"),  # Fold 7: 2023 H2
            ("2021-01-01", "2023-12-31", "2024-01-01", "2024-06-30"),  # Fold 8: 2024 ATH
            ("2019-01-01", "2022-06-30", "2022-07-01", "2023-06-30"),  # Fold 9: Extended test 1yr
            ("2020-01-01", "2023-06-30", "2023-07-01", "2024-06-30"),  # Fold 10: Extended test 1yr
            ("2019-01-01", "2021-12-31", "2022-01-01", "2023-12-31"),  # Fold 11: 2yr test
            ("2019-01-01", "2022-12-31", "2023-01-01", "2024-06-30"),  # Fold 12: Final validation
        ]
